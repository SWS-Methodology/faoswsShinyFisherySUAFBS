             ...
             column(12,
                    ...
                    column(10,
                           h4('Note this tab is to perform block or single extraction rate updates.
                              Update the series of each product (measuredItemFaostat_L2) only with one value.'),
                           h5('For example, do not put different values for different years. Use the data validation tab for this detailed operations.'),
                      ...
                      column(4,
                            ...
                            radioButtons(inputId = "reprocess", 
                                         ...
                                         choices = list("No calculations wanted" = 'No',
                                                        "Complete" = 'Complete', 
                                                        "Only SUAbalanced" = 'SUAb',
                                                        "Since SUAbalanced" = 'SUAbTot',
