...
foodProcessingComputation <- function(SUAinput, treeNewER, primary){
  ...
  toDeviate2proc2[, availability_secondary_primEq_tot := sum(availability_secondary_primEq, na.rm = TRUE), by = list(geographicAreaM49_fi,
                                                                                                       timePointYears,
                                                                                                       parent_primary) ]
  ...
  secondaryFP <-  merge(unique(treeNewER[, .(parent, rank)]), unique(toDeviate2proc2[, .(geographicAreaM49_fi,
                                                                                 timePointYears,
                                                                                 parent_primary,
                                                                                 parent_secondary, 
